...
export const SchedulerTour = async () =>
{
      await createTour({
          ...
          type: 1,
          status: 0,
          tournamentDate: new Date('2025-12-06T13:30:00.000Z'),
          startHour: 13,
          startMinute: 0,
          ...
          tournamentName: "Stumble Rush 1v1 - Block Dash",
          maxInvites: 256,
          partySize: 1,
          currentInvites: 0,
          phaseCount: 1,
          ...
          sponsorImageUrl: "",
          imageUrl: null,
          iconUrl: "https://i.imgur.com/Bl3eQrB.png",
          highlightsUrl: "https://discord.gg/beastsg",
          streamUrl: "https://discord.gg/sgaura",
          serverRegion: "EU",
          entryFeeType: 10,
